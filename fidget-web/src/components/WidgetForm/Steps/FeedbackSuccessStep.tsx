  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center pt-10">
        ...
        <span className="text-xl leading-6 mt-2">Agradecemos o feedback!</span>
        <button
          className="py-2 px-6 mt-6 rounded-md border-transparent text-sm leading-6 bg-zinc-800 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
